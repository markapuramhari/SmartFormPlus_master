package com.cropin.commonutils;
...
public class ExcelUtil {
	...
	public static  synchronized void writeDataFromExcel(String filepath,String Sheetname,int rowcount,int columncount,String value)
	{
	    try
	    {
